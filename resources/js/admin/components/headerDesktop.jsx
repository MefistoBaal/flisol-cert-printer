                ...
                <div className="section__content section__content--p35">
                    <div className="header3-wrap">
                        <div className="header__logo">
                            <a href="#"> <img src="images/icon/logo-white.png" alt="CoolAdmin"/> </a>
                        </div>
                        <div className="header__navbar">
                            <ul className="list-unstyled">
                                <li className="has-sub">
                                    <a href="#">
                                        <i className="fas fa-tachometer-alt"/>Dashboard <span className="bot-line"/>
                                    </a>
                                ...
                                <li>
                                    <a href="#"> <i className="fas fa-shopping-basket"/>
                                        <span className="bot-line"/>eCommerce</a>
                                </li>
                                <li>
                                    <a href="table.html"> <i className="fas fa-trophy"/>
                                        <span className="bot-line"/>Features</a>
                                </li>
                                <li className="has-sub">
                                    <a href="#"> <i className="fas fa-copy"/> <span className="bot-line"/>Pages</a>
                                    <ul className="header3-sub-list list-unstyled">
                                        <li>
                                ...
                                <li className="has-sub">
                                    <a href="#"> <i className="fas fa-desktop"/> <span className="bot-line"/>UI
                                        Elements</a>
                                    <ul className="header3-sub-list list-unstyled">
                                        <li>
